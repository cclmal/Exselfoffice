...
var _excluded3 = ["anchorEl", "children", "component", "direction", "disablePortal", "modifiers", "open", "placement", "popperOptions", "popperRef", "slotProps", "slots", "TransitionProps", "ownerState"];
...
var PopperTooltip = React8.forwardRef(function PopperTooltip2(props, ref) {
  var _ref;
  const {
    anchorEl,
    children,
...
var PopperUnstyled = React8.forwardRef(function PopperUnstyled2(props, ref) {
  const {
    anchorEl,
    children,
...
function useCompoundParent() {
  ...
  const registerItem = React28.useCallback(function registerItem2(id, item, missingKeyGenerator) {
...
function useMenu(parameters = {}) {
  ...
  const controlledProps = React29.useMemo(() => ({
    open: openProp
  }), [openProp]);
  const stateChangeHandler = React29.useCallback((event, field, fieldValue, reason, state) => {
    if (field === "open") {
...
var _excluded8 = ["actions", "anchorEl", "children", "component", "defaultOpen", "listboxId", "onOpenChange", "open", "slotProps", "slots"];
...
function useCompoundItem(id, itemMetadata, missingKeyGenerator) {
  ...
  const [registeredId, setRegisteredId] = React32.useState(id);
  useEnhancedEffect_default(() => {
    const {
      id: returnedId,
      deregister
...
var _excluded9 = ["children", "disabled", "component", "label", "slotProps", "slots"];
...
var MenuItemUnstyled = React34.forwardRef(function MenuItemUnstyled2(props, ref) {
  var _ref;
  const {
    children,
    disabled: disabledProp = false,
...
var OptionUnstyled = React37.forwardRef(function OptionUnstyled2(props, ref) {
...
var OptionUnstyled_default = React37.memo(OptionUnstyled);
...
function useSelect(props) {
  ...
  const handleStateChange = React38.useCallback((e, field, fieldValue) => {
    if (field === "open") {
      onOpenChange == null ? void 0 : onOpenChange(fieldValue);
  ...
  const getOptionMetadata = React38.useCallback((optionValue) => options.get(optionValue), [options]);
  const getListboxProps = (otherHandlers = {}) => {
...
var SelectUnstyled = React40.forwardRef(function SelectUnstyled2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime24.jsxs)(React40.Fragment, {
...
var SliderUnstyled = React41.forwardRef(function SliderUnstyled2(props, ref) {
...
var TabsUnstyled = React50.forwardRef(function TabsUnstyled2(props, ref) {
  var _ref;
  const {
    children,
    orientation = "horizontal",
...
var TabPanelUnstyled = React51.forwardRef(function TabPanelUnstyled2(props, ref) {
  var _ref;
  const {
    children,
    component,
...
var TabsListUnstyled = React54.forwardRef(function TabsListUnstyled2(props, ref) {
  var _ref;
  const {
    children,
    component,
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-3PJJXWG3.js.map
